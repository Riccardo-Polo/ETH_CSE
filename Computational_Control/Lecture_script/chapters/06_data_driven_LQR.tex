...
$K$ and $P$. Second, the term $\Tr(K^\top R K\,P)$ also contains products of the decision
...
& \Tr(QP)+\Tr\!\big(G^\top U_0^\top R U_0 G P\big)\\
\text{s.t.}\quad
& X_1GPG^\top X_1^\top - P + I \preceq 0,\\
& X_0G = I.
\end{aligned}
...
\begin{aligned}
\min_{P \succeq I,\;K,\;G}\quad
& \Tr(QP)+\Tr(K^\top RKP)+\lambda \|GPG^\top\| \\
\text{s.t.}\quad
& X_1GPG^\top X_1^\top - P + I \preceq 0,\\
& \begin{bmatrix}
K\\[0.3em]
