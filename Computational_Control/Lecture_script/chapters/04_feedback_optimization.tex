...
The conclusion is that, f\textbf{for a fast and exponentially stable plant}, the dynamic relation between $u$ and $y$ can be replaced at steady state by the static map
\[
y = Hu + Lw,
\]
