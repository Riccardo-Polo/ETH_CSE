function [fig_time,axes_time,fig_pos,axes_pos] = plot_trajectory_cwo(x,u,ctrl_info,params)
...
% final time
%t_safe_max = params.constraints.t_safe_max;
%xline(t_safe_max)
legend('Location','EastOutside')
ylabel('Position [Mm]')
...
hold on
colormap('hsv')
% plot(0,0,'Marker',"square",'MarkerSize',10)
