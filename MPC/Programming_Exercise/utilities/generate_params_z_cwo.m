function [params_z] = generate_params_z_cwo(params)
% initialize params_z
params_z = params;

% add initial condition of z-subsystem
params_z.exercise = rmfield(params_z.exercise,{'InitialConditionA', ...
                             'InitialConditionB', ...
                             'InitialConditionC'});
params_z.exercise.InitialConditionA_z = [0.09;0.051]; % TODO: tune
